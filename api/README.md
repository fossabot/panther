...
* [DEPRECATED] Invoking a Lambda function directly as an API, using the [genericapi](../pkg/genericapi) library.
These APIs are defined purely by Go request/response models.
* API Gateway proxies requests to a Lambda function, assisted by the [gatewayapi](../pkg/gatewayapi) library.
